 ...
 * My Staff
 */
export const myStaffAuthMyStaffGet = <ThrowOnError extends boolean = false>(options?: Options<MyStaffAuthMyStaffGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<MyStaffAuthMyStaffGetResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
