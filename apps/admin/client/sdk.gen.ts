 ...
 */
export const getMessTablesMessTablesMessMessIdGet = <ThrowOnError extends boolean = false>(options: Options<GetMessTablesMessTablesMessMessIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMessTablesMessTablesMessMessIdGetResponses, GetMessTablesMessTablesMessMessIdGetErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * Delete table
 */
export const deleteMessTableMessTablesTableIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteMessTableMessTablesTableIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteMessTableMessTablesTableIdDeleteResponses, DeleteMessTableMessTablesTableIdDeleteErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * Get specific table
 */
export const getMessTableMessTablesTableIdGet = <ThrowOnError extends boolean = false>(options: Options<GetMessTableMessTablesTableIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMessTableMessTablesTableIdGetResponses, GetMessTableMessTablesTableIdGetErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * Update table
 */
export const updateMessTableMessTablesTableIdPut = <ThrowOnError extends boolean = false>(options: Options<UpdateMessTableMessTablesTableIdPutData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateMessTableMessTablesTableIdPutResponses, UpdateMessTableMessTablesTableIdPutErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * Create new table
 */
export const createMessTableMessTablesPost = <ThrowOnError extends boolean = false>(options: Options<CreateMessTableMessTablesPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateMessTableMessTablesPostResponses, CreateMessTableMessTablesPostErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
